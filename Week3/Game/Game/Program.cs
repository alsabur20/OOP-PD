...
namespace Game
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // Snake Left Wall
            SnakeLeft sLeft = new SnakeLeft(2,3);
            ...
            // Snake Right Wall
            SnakeRight sRight = new SnakeRight(50,3);
        ...
        {
            SnakeLeft temp = new SnakeLeft(sLeft.xPos, sLeft.yPos);
            int x = sLeft.xPos;
            int y = sLeft.yPos;
        ...
        {
            SnakeRight temp = new SnakeRight(sRight.xPos, sRight.yPos);
            int x = sRight.xPos;
            int y = sRight.yPos;
            for (int row = 3; row >= 0; row--)
            {
